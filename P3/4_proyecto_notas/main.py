...
def main():
    ...
    while opcion:
        ...
        if opcion=="1" or opcion=="REGISTRO":
            ...
            if regresar == True:
                print(f"{nombre} se regiistro correctamente con el email: {email}")
            else:
                print(f"Por favor intentelo de nuevo, no fue posible registrar el usuario en este momento.")
            ...
            if lista_usuario:
                print(f"{lista_usuario[0]} {lista_usuario[1]} {lista_usuario[2]}")

            else:
                print("el usuario o el email son incorrectos por favor intentalo nuevamente")
            funciones.esperarTecla
